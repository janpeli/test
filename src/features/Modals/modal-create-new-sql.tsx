import { closeModals, createSqlFromModal } from "@/API/GUI-api/modal-api";
...
function ModalCreateNewSql() {
  ...
  const handleCreateFile = useCallback(async () => {
    ...
    try {
      await createSqlFromModal(fileName.trim());
      closeModals();
    } catch (err) {
  ...
  return (
    <>
      <DialogHeader>
        ...
        <DialogDescription>Enter a name for your new SQL file (.sql will be appended)</DialogDescription>
      </DialogHeader>
